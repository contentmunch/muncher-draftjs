...
export const LongDocument = Template.bind({});
LongDocument.args = {
    content: "<h1>This is a heading</h1>\n" +
        ...
        "<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?</p>\n" +
        "<p></p>\n" +
        "<p>This is test for <span class=\"color-brown\">sure</span> don&#x27;t you <strong>think</strong>🤭. This is slow as hell why the hell is ti so slow. it is not is it?</p>\n" +
        "<p> eveything seems to work fine htere... Now oyu are not goin gto slow down are you?</p>\n" +
        "<p></p>\n" +
        "<p></p>\n" +
        "<p></p>\n" +
        "<p></p>\n" +
